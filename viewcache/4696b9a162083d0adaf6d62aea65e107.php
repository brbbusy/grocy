	...
	<div class="col">
		<div class="title-related-links">
			...
			<div class="related-links collapse d-md-flex order-2 width-xs-sm-100"
				...
				<a class="btn btn-outline-dark responsive-button m-1 mt-md-0 mb-md-0 float-right"
					href="<?php echo e($U('/locationcontentsheet')); ?>">
					<?php echo e($__t('Location Content Sheet')); ?>
			...
			<tbody class="d-none">
				...
				<tr id="product-<?php echo e($currentStockEntry->product_id); ?>-row"
					...
					<td class="fit-content border-right">
						...
						<a class="btn btn-success btn-sm product-open-button <?php if($currentStockEntry->amount_aggregated < $currentStockEntry->quick_open_amount || $currentStockEntry->amount_aggregated == $currentStockEntry->amount_opened_aggregated || $currentStockEntry->enable_tare_weight_handling == 1): ?> disabled <?php endif; ?>"
							href="#"
							data-toggle="tooltip"
							data-placement="left"
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/www/views/stockoverview.blade.php ENDPATH**/ ?>