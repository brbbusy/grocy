...
<?php $__env->startSection('title', $__t('Locations')); ?>
		...
		<div class="title-related-links">
			...
			<div class="related-links collapse d-md-flex order-2 width-xs-sm-100"
				...
				<a class="btn btn-primary responsive-button m-1 mt-md-0 mb-md-0 float-right show-as-dialog-link"
					href="<?php echo e($U('/location/new?embedded')); ?>">
					<?php echo e($__t('Add')); ?>

				</a>
				<a class="btn btn-outline-secondary m-1 mt-md-0 mb-md-0 float-right"
					href="<?php echo e($U('/userfields?entity=locations')); ?>">
	...
	<div class="col">
		<table id="locations-table"
			...
			<tbody class="d-none">
				...
				<tr class="<?php if($location->active == 0): ?> text-muted <?php endif; ?>">
					<td class="fit-content border-right">
						<a class="btn btn-info btn-sm show-as-dialog-link"
							href="<?php echo e($U('/location/')); ?><?php echo e($location->id); ?>?embedded"
							data-toggle="tooltip"
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/www/views/locations.blade.php ENDPATH**/ ?>